#
#  Be sure to run `pod spec lint ESTextView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/EverydayStep/ESTextView.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ESTextView/ESTextView/*.{h,m}"
